...
public class FavouritesFragment extends Fragment implements CustomErrorDialog.ErrorDialogTaskDone,PostRequestAsyncTask.RequestDoneTaskListener{
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.setTag(TAG);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_fav);
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        postRequestAsyncTask.execute("http://" + Constants.IP_ADDRESS + "getfavclassespro");
