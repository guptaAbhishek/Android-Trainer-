    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0){
                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+919873805309"));
                    context.startActivity(intent);
                }else if(position==1){
                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "thepoweryoga@gmail.com", null));
